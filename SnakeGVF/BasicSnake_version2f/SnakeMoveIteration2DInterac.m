function P=SnakeMoveIteration2DInterac(B,P,Fext,gamma,kappa,delta, r, springs)
...
ssx = gamma*P(:,1) + Fext1(:,1) + Fext2(:,1) + FSpring(:,1);
ssy = gamma*P(:,2) + Fext1(:,2) + Fext2(:,2) + FSpring(:,2);
P(:,1) = B * ssx;
P(:,2) = B * ssy;
