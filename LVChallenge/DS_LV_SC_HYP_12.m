...
filename = 'C:/DocsMaracuya/Datos/LVChallenge/ShortAxis/SC-HYP-12/IM-0629-0001.dcm' ;
...
P1Options.Alpha = .01; % Membrame energy  (first order), default 0.2
P1Options.Beta = .5; %  Thin plate energy (second order), default 0.2
P1Options.Delta = +0.011; %  Baloon force, default 0.1
P1Options.Kappa = .002; %  Weight of external image force, default 2


% Second snake

P2Options.minWidth = 7; %  Distance between two snakes in pixels.
P2Options.maxWidth = 15; %  Distance between two snakes in pixels.
